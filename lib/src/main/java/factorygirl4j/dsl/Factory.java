...
public class Factory<ObjectType> {
    ...
    public Factory<ObjectType> association(String propertyName){
        objectFields.put(propertyName, new KeyValuePair(propertyName, FactoryGirl.findFactory(propertyName)));
        return this;
    }
    ...
    public Factory<ObjectType> association(String propertyName, FactoryName factoryName){
        objectFields.put(propertyName, new KeyValuePair(propertyName,
                FactoryGirl.findFactory(factoryName.fetch())));
    ...
    public Factory<ObjectType> after(FactoryGirlOperation operation, AfterCallback<ObjectType> callback){
    ...
    @SuppressWarnings("unchecked")
    ObjectType invokeAfterCallbacks(FactoryGirlOperation operation, ObjectType product){
    ...
    ObjectType create(SaveStrategy<ObjectType> saveStrategy, KeyValuePairs keyValuePairs)
        ...
        return this.invokeAfterCallbacks(FactoryGirlOperation.CREATE, saveStrategy.save(this.build(keyValuePairs)));
    }
    ...
    ObjectType create(SaveStrategy<ObjectType> saveStrategy) throws IOException, NoSuchFieldException,
        ...
        return this.invokeAfterCallbacks(FactoryGirlOperation.CREATE, saveStrategy.save(this.build()));
    }
}
